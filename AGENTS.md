...
Prefer a minimal Tailwind approach. It is a default, not a hard rule - bend it when doing so clearly improves clarity or reuse. Use CSS for complex effects or things that Tailwind does not support.
